...
SCENARIO_TEMPLATES: list[dict] = [
    ...
    # ── Disque avance ─────────────────────────────────────────────────
    {"name": "sys_espace_disque", "category": "systeme", "difficulty": "easy",
     "description": "Voir l'espace disque",
     "voice_input": "espace disque", "expected": ["espace_disque"],
     "expected_result": "Espace disque affiche"},
    {"name": "sys_nettoyer_disque", "category": "systeme", "difficulty": "normal",
     "description": "Lancer le nettoyage de disque",
     "voice_input": "nettoie le disque", "expected": ["nettoyer_disque"],
     "expected_result": "Cleanmgr lance"},
